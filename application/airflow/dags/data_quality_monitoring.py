        ...
        if result:
            ...
            metrics.append(
                QualityMetric(
                    ...
                    status=(
                        "PASS" if recent_objects >= QUALITY_THRESHOLDS["min_catalog_objects_per_hour"] else "WARNING"
                    ),
...
"""
    ...
    for metric in quality_summary["metrics"]:
        status_icon = {"PASS": "✓", "WARNING": "⚠", "CRITICAL": "✗"}.get(metric["status"], "?")
