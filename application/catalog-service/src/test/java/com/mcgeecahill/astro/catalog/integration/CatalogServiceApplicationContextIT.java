package com.mcgeecahill.astro.catalog.integration;

import static org.assertj.core.api.Assertions.assertThat;
import static org.junit.jupiter.api.Assertions.assertDoesNotThrow;

import com.mcgeecahill.astro.catalog.CatalogServiceApplication;
...
class CatalogServiceApplicationContextIT {
    ...
    void postGISConfigurationShouldBeValid() {
        ...
        assertDoesNotThrow(
                () -> {
                    String version =
                            jdbcTemplate.queryForObject("SELECT PostGIS_Version()", String.class);
