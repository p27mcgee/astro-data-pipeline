...
@NoArgsConstructor
@AllArgsConstructor
public final class ConeSearchResult {
    ...
    public String getMagnitudeRange() {
        ...
        if (brightest != null && faintest != null) {
            return String.format(
                    "%.2f - %.2f mag", brightest.getMagnitude(), faintest.getMagnitude());
        }
        return "N/A";
    }
    ...
    public static final class ConeSearchResultBuilder {
    ...
    @NoArgsConstructor
    @AllArgsConstructor
    public static final class ObjectMatch {
