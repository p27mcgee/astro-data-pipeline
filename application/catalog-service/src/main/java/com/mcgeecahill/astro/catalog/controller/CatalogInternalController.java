...
@Tag(
        name = "Catalog Management (Internal)",
        description = "Internal API for catalog ingestion and maintenance")
...
public class CatalogInternalController {
    ...
    @Operation(
            summary = "Bulk import astronomical objects",
            description =
                    "Imports multiple objects from image processing pipeline. Used by"
    ...
    @Operation(
            summary = "Save single astronomical object",
    ...
    @Operation(
            summary = "Clean up transient objects",
    ...
    public ResponseEntity<Map<String, Object>> cleanupTransients(
            @Parameter(description = "Delete objects older than days")
