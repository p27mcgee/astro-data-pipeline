...
@NoArgsConstructor
@AllArgsConstructor
public final class ObjectMatchResult {
    ...
    public String getMatchSummary() {
        ...
        return String.format(
                "Match: %s, separation: %s, confidence: %.1f%%, quality: %s",
                matchedObject.getName() != null
                        ? matchedObject.getName()
                        : "Object " + matchedObject.getId(),
    ...
    public static final class ObjectMatchResultBuilder {
