...
public class GranularProcessingResponse {
    ...
    @Schema(
            description = "S3 path to the processed output image",
            example = "intermediate-data/session-123/dark-subtracted/image001.fits")
    ...
    @Schema(
            description = "S3 key prefix for organizing results by processing context",
            example = "experimental/cosmic-ray-comparison/2024-09-28/exp-20240928-a1b2c3d4")
    @JsonProperty("s3KeyPrefix")
    private String s3KeyPrefix;

    @Schema(description = "Database partition key for efficient querying", example = "exp_202409")
