...
public class JobSubmissionRequest {
    ...
    @Builder.Default private boolean enableDarkSubtraction = true;

    @Builder.Default private boolean enableFlatCorrection = true;

    @Builder.Default private boolean enableCosmicRayRemoval = true;

    @Builder.Default private boolean enableQualityAssessment = true;
