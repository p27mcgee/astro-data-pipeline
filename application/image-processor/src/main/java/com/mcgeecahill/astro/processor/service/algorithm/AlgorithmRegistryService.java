...
public class AlgorithmRegistryService {
    ...
    public void initializeRegistry() {
        ...
        List<AlgorithmInfo> darkSubtractionAlgorithms =
                Arrays.asList(
                        AlgorithmInfo.builder()
                                .id("default")
                                .name("Standard Dark Subtraction")
                                .description(
                                        "Basic pixel-wise dark current subtraction using master"
                                                + " dark frame")
                                .version("1.0")
                                .parameters(
                                        Map.of(
                                                "scaleFactor",
                                                "Scaling factor for dark frame (default:" + " 1.0)",
                                                "useMedianScaling",
                                                "Use median-based scaling instead of mean"
                                                        + " (default: false)"))
                                .supported(true)
                                .experimental(false)
                                .build(),
                        AlgorithmInfo.builder()
                                ...
                                .description(
                                        "Dark subtraction with automatic exposure time scaling")
                                .version("1.1")
                                .parameters(
                                        Map.of(
                                                "autoScale",
                                                "Automatically scale based on exposure time"
                                                        + " (default: true)",
                                                ...
                                                "maxScaleFactor",
                                                "Maximum allowed scale factor (default:"
                                                        + " 10.0)"))
                                .supported(true)
                                .experimental(false)
                                .build(),
                        AlgorithmInfo.builder()
                                ...
                                .description(
                                        "Adaptive dark subtraction with local variance estimation")
                                .version("2.0")
                                .parameters(
                                        Map.of(
                                                "windowSize",
                                                "Local estimation window size (default:" + " 64)",
                                                "adaptiveThreshold",
                                                "Adaptation threshold (default: 3.0)",
                                                "preserveStars",
                                                "Preserve stellar sources during adaptation"
                                                        + " (default: true)"))
                                .supported(true)
                                .experimental(true)
                                .build());
        ...
        List<AlgorithmInfo> flatCorrectionAlgorithms =
                Arrays.asList(
                        AlgorithmInfo.builder()
                                .id("default")
                                .name("Standard Flat Field Correction")
                                .description(
                                        "Traditional flat field correction using master flat frame")
                                .version("1.0")
                                .parameters(
                                        Map.of(
                                                "normalizationMethod",
                                                "Normalization method: mean, median, mode"
                                                        + " (default: median)",
                                                "outlierRejection",
                                                "Enable outlier rejection (default: true)",
                                                "rejectionSigma",
                                                "Outlier rejection sigma threshold"
                                                        + " (default: 3.0)"))
                                .supported(true)
                                .experimental(false)
                                .build(),
                        AlgorithmInfo.builder()
                                ...
                                .description(
                                        "Flat field correction with illumination pattern removal")
                                .version("1.2")
                                .parameters(
                                        Map.of(
                                                "illuminationModel",
                                                "Illumination model: polynomial, spline"
                                                        + " (default: polynomial)",
                                                "polynomialDegree",
                                                "Polynomial degree for illumination model"
                                                        + " (default: 3)",
                                                "maskStars",
                                                "Mask stars during illumination fitting"
                                                        + " (default: true)",
                                                "starMaskRadius",
                                                "Star masking radius in pixels (default:" + " 5)"))
                                .supported(true)
                                .experimental(false)
                                .build());
        ...
        List<AlgorithmInfo> cosmicRayAlgorithms =
                Arrays.asList(
                        AlgorithmInfo.builder()
                                .id("lacosmic")
                                .name("L.A.Cosmic")
                                .description(
                                        "Laplacian cosmic ray detection algorithm (van Dokkum"
                                                + " 2001)")
                                .version("1.0")
                                .parameters(
                                        Map.of(
                                                "sigclip",
                                                "Sigma clipping threshold (default: 4.5)",
                                                "sigfrac",
                                                "Fractional detection limit (default: 0.3)",
                                                "objlim",
                                                "Object detection limit (default: 5.0)",
                                                "gain",
                                                "CCD gain in e-/ADU (default: 1.0)",
                                                "readnoise",
                                                "Read noise in e- (default: 6.5)",
                                                "niter",
                        ...
                        AlgorithmInfo.builder()
                                ...
                                .parameters(
                                        Map.of(
                                                ...
                                                "Maximum number of iterations (default: 4)",
                                                "starPreservation",
                                                "Enhanced star preservation (default:" + " true)",
                                                "edgeHandling",
                                                "Improved edge handling (default: true)"))
                                .supported(true)
                                .experimental(false)
                                .build(),
                        AlgorithmInfo.builder()
                                ...
                                .parameters(
                                        Map.of(
                                                ...
                                                "iterations",
                                                "Number of filter iterations (default: 1)"))
                                .supported(true)
                                .experimental(false)
                                .build(),
                        AlgorithmInfo.builder()
                                ...
                                .description(
                                        "Deep learning-based cosmic ray detection (experimental)")
                                .version("0.1")
                                .parameters(
                                        Map.of(
                                                "modelPath",
                                                ...
                                                "Detection confidence threshold (default:"
                                                        + " 0.8)",
                                                "patchSize",
                                                "Input patch size (default: 64)",
                                                "overlap",
                                                "Patch overlap factor (default: 0.25)"))
                                .supported(false)
                                .experimental(true)
                                .build());
        ...
        List<AlgorithmInfo> biasSubtractionAlgorithms =
                Arrays.asList(
                        AlgorithmInfo.builder()
                                .id("default")
                                ...
                                .parameters(
                                        Map.of(
                                                "overscanCorrection",
                                                "Apply overscan correction (default: true)",
                                                "overscanRegion",
                                                "Overscan region [x1,y1,x2,y2] (auto-detect"
                                                        + " if empty)",
                                                "fitMethod",
                                                "Overscan fit method: mean, median,"
                                                        + " polynomial (default: median)"))
                                .supported(true)
                                .experimental(false)
                                .build(),
                        AlgorithmInfo.builder()
                                ...
                                .parameters(
                                        Map.of(
                                                ...
                                                "Enable outlier rejection (default: true)",
                                                "rejectionMethod",
                                                "Rejection method: sigma, mad, percentile"
                                                        + " (default: sigma)",
                                                "rejectionThreshold",
                                                "Rejection threshold (default: 3.0)",
                                                "iterativeRejection",
                                                "Use iterative rejection (default: true)"))
                                .supported(true)
                                .experimental(false)
                                .build());
        ...
        log.info(
                "Algorithm registry initialized with {} algorithm types and {} total algorithms",
    ...
    public Map<String, Object> getAlgorithmSummary() {
        ...
        for (Map.Entry<String, List<AlgorithmInfo>> entry : algorithmRegistry.entrySet()) {
            ...
            typeSummary.put(
                    "supported", algorithms.stream().mapToInt(a -> a.isSupported() ? 1 : 0).sum());
            typeSummary.put(
                    "experimental",
                    algorithms.stream().mapToInt(a -> a.isExperimental() ? 1 : 0).sum());
            typeSummary.put(
                    "algorithms",
                    algorithms.stream()
                            .map(
