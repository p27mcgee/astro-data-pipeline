...
@Tag(
        name = "Granular Processing (Internal)",
        description =
                "Internal API for individual processing steps - Used by Airflow research workflows")
@InternalApi("Orchestrated by Airflow DAGs for research and custom processing workflows")
public class GranularProcessingController {
    ...
    @Operation(
            ...
            description =
                    "Performs dark current subtraction using specified dark frame. Result stored in"
                            + " intermediate bucket for chaining.")
    ...
    public ResponseEntity<GranularProcessingResponse> applyDarkSubtraction(
        ...
        GranularProcessingResponse response =
                granularProcessingService.applyDarkSubtraction(request);
    ...
    @Operation(
            ...
            description =
                    "Performs flat field correction using specified flat frame. Result stored in"
                            + " intermediate bucket for chaining.")
    ...
    @Operation(
            ...
            description =
                    "Applies L.A.Cosmic algorithm for cosmic ray detection and removal. Result"
                            + " stored in intermediate bucket for chaining.")
    ...
    @Operation(
            ...
            description =
                    "Performs bias frame subtraction. Result stored in intermediate bucket for"
                            + " chaining.")
    ...
    @Operation(
            ...
            description =
                    "Executes a custom sequence of processing steps with specified algorithms and"
                            + " parameters")
    ...
    public ResponseEntity<?> getAvailableAlgorithms(
            @Parameter(description = "Type of processing step") @PathVariable
    ...
    @Operation(
            ...
            description =
                    "Returns list of intermediate files created during granular processing session")
    ...
    public ResponseEntity<?> getIntermediateResults(
            @Parameter(description = "Processing session ID") @PathVariable String sessionId) {
