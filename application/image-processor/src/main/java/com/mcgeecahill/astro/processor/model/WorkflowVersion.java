 ...
 *
 * <p>Enables workflow versioning, activation states, and traffic splitting for production vs
...
public class WorkflowVersion {
    ...
    public double getEffectiveTrafficPercentage() {
        return isCurrentlyActive()
                ? (trafficSplitPercentage != null ? trafficSplitPercentage : 0.0)
                : 0.0;
    }
    ...
    public boolean isRecentlyUsed() {
        return lastUsedAt != null
                && lastUsedAt.isAfter(
                        LocalDateTime.now().minusDays(TimeConstants.DAYS_FOR_WORKFLOW_RETENTION));
    }
    ...
    public Double getAverageProcessingTime() {
        if (performanceMetrics != null
                && performanceMetrics.containsKey("avg_processing_time_ms")) {
    ...
    public static WorkflowVersion createActive(
            String workflowName,
    ...
    public static WorkflowVersion createExperimental(
            String workflowName,
            String workflowVersion,
            String researcherId,
            String hypothesis,
