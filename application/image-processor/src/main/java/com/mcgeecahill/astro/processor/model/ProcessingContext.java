 ...
 *
 * <p>Provides a unified way to track production vs experimental processing, enable database
 * partitioning, and maintain experiment lineage.
 */
@Data
@Builder
@NoArgsConstructor
...
public class ProcessingContext {
    ...
    /**
     * Unique processing ID - UUID format for global uniqueness Enhanced Format:
     * {type}-{version}-{timestamp}-{uuid} Examples:
    ...
    /**
     * Processing session ID - groups related processing steps For production: typically the
     * observation ID or batch ID For experiments: researcher-defined experiment session
     */
    ...
    public static String generateProcessingId(
            ProcessingType type, String workflowVersion, String workflowName) {
        ...
        if (type == ProcessingType.EXPERIMENTAL && workflowName != null) {
            ...
            return String.format("%s-%s-%s-%s", type.getPrefix(), workflowVersion, timestamp, uuid);
        }
    }
    ...
    public String getS3KeyPrefix() {
        ...
        if (isProduction()) {
            ...
            String experimentName =
                    experimentContext != null && experimentContext.getExperimentName() != null
                            ? experimentContext.getExperimentName()
                            : "unnamed";
    ...
    public static ProcessingContext createProductionContext(
            String sessionId, String observationId, String instrumentId) {
    ...
    public static ProcessingContext createExperimentalContext(
            String sessionId, String experimentName, String researcherId, String researcherEmail) {
        return ProcessingContext.builder()
        ...
        return ProcessingContext.builder()
                ...
                .dataLineage(
                        DataLineage.builder()
                                ...
                                .rootProcessingId(
                                        this.dataLineage != null
                                                ? this.dataLineage.getRootProcessingId()
                                                : this.processingId)
                                .processingDepth(
                                        (this.dataLineage != null
                                                        ? this.dataLineage.getProcessingDepth()
                                                        : 0)
                                                + 1)
                                .build())
                .build();
