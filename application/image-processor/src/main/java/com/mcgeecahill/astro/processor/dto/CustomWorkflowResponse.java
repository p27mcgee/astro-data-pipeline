...
public class CustomWorkflowResponse {
    ...
    @Schema(
            description = "S3 path to final processed image",
            example = "processed-data/experiment-001/final/image001.fits")
    ...
    public static class StepResult {
        ...
        @Schema(
                description = "Output path for this step",
                example = "intermediate-data/session-123/step-2/image001.fits")
