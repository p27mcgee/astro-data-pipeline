 ...
 *
 * <p>FIXME: These security tests are currently disabled due to CSRF token and authentication
 * issues. The tests fail with 403 Forbidden responses instead of expected validation errors because
 * Spring Security intercepts requests before they reach validation logic. To fix: 1. Either disable
 * CSRF for these specific tests using @WithMockUser or CSRF tokens 2. Or refactor to test security
 * at a different layer 3. Consider separating input validation tests from security tests
 */
@SpringBootTest
...
class ProcessingControllerSecurityIT {
    ...
    /*
    @Test
    void submitJobWithMaliciousPayloadShouldReject() throws Exception {
    ...
    @Test
    void submitJobWithOversizedPayloadShouldReject() throws Exception {
    ...
    @Test
    void submitJobWithInvalidJsonShouldReturn400() throws Exception {
        // When & Then
        mockMvc.perform(post("/api/v1/processing/jobs")
                .with(httpBasic("admin", "admin"))
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    void submitJobWithMissingRequiredFieldsShouldReturn400() throws Exception {
    ...
    @Test
    void submitJobWithXmlContentTypeShouldReturn415() throws Exception {
        // Given
    ...
    @Test
    void submitJobWithPlainTextContentTypeShouldReturn415() throws Exception {
        // Given
    ...
    @Test
    void getJobStatusWithPathTraversalAttemptShouldHandleSafely() throws Exception {
    ...
    @Test
    void getJobStatusWithNullByteInjectionShouldHandleSafely() throws Exception {
    ...
    @Test
    void processJobsWithUnsupportedHttpMethodShouldReturn405() throws Exception {
        // When & Then
    ...
    @Test
    void getMetricsWithPostMethodShouldReturn405() throws Exception {
        // When & Then
    ...
    @Test
    void submitMultipleJobsRapidlyShouldHandleGracefully() throws Exception {
        // Given
    ...
    @Test
    void listJobsWithExtremePageSizeShouldLimitResults() throws Exception {
    ...
    @Test
    void listJobsWithNegativePageNumberShouldHandleGracefully() throws Exception {
        // When & Then
        mockMvc.perform(get("/api/v1/processing/jobs")
                .with(httpBasic("admin", "admin"))
                .param("page", "-1")
    ...
    @Test
    void cleanupJobsWithExtremeParametersShouldHandleGracefully() throws Exception {
        // When & Then
    ...
    @Test
    void allEndpointsShouldIncludeSecurityHeaders() throws Exception {
