...
import com.mcgeecahill.astro.processor.ImageProcessorApplication;
import com.mcgeecahill.astro.processor.config.TestMetricsConfig;
...
@SpringBootTest(
        classes = {ImageProcessorApplication.class, TestMetricsConfig.class},
        webEnvironment = SpringBootTest.WebEnvironment.NONE,
        // FIXME: Excluding metrics auto-configuration due to MetricsCollector constructor
...
@TestPropertySource(
        properties = {"spring.profiles.active=${SPRING_PROFILES_ACTIVE:application-context-test}"})
