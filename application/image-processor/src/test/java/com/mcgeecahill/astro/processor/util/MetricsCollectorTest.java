...
class MetricsCollectorTest {
    ...
    @Test
    void constructorShouldInitializeAllMeters() {
    ...
    @Test
    void recordProcessingSuccessShouldIncrementCountersAndRecordTime() {
        // Given
        ...
        Counter typeCounter =
                meterRegistry
                        .find("fits_processing_by_type_total")
    ...
    @Test
    void recordProcessingFailureShouldIncrementErrorCounters() {
        // Given
    ...
    @Test
    void recordImageQualityShouldIncrementCounterAndCategorize() {
        // Given
        ...
        // Then
        Counter excellentCounter =
                meterRegistry
                        .find("fits_image_quality_category_total")
    ...
    @Test
    void recordCosmicRayDetectionShouldIncrementByCount() {
        // Given
    ...
    @Test
    void recordCalibrationStepDarkSubtractionShouldIncrementCorrectCounter() {
        // When
    ...
    @Test
    void recordCalibrationStepFlatCorrectionShouldIncrementCorrectCounter() {
        // When
    ...
    @Test
    void recordCalibrationStepCustomStepShouldIncrementGenericCounter() {
        // When
        metricsCollector.recordCalibrationStep("custom_step");

        // Then
        Counter customCounter =
                meterRegistry.find("calibration_steps_total").tag("step", "custom_step").counter();
        assertNotNull(customCounter);
        assertEquals(1.0, customCounter.count());
    }

    @Test
    void recordIOOperationShouldIncrementCountersAndRecordTime() {
        // Given
        ...
        Counter bytesCounter =
                meterRegistry.find("fits_io_bytes_total").tag("operation", operation).counter();
        assertNotNull(bytesCounter);
        assertEquals(1048576.0, bytesCounter.count());

        Counter operationsCounter =
                meterRegistry
                        .find("fits_io_operations_total")
    ...
    @Test
    void recordMemoryUsageShouldIncrementCounter() {
        // Given
        ...
        Counter memoryCounter =
                meterRegistry.find("fits_processing_memory_usage_total_mb").counter();
        assertNotNull(memoryCounter);
        assertEquals(512.0, memoryCounter.count());
    }

    @Test
    void recordThroughputShouldIncrementCounter() {
        // Given
        ...
        Counter throughputCounter =
                meterRegistry.find("fits_processing_throughput_total_pixels").counter();
        assertNotNull(throughputCounter);
        assertEquals(1000000.0, throughputCounter.count());
    }

    @Test
    void updateActiveJobsShouldUpdateGauge() {
        // Given
        long activeJobs = 5L;
    ...
    @Test
    void updateQueueSizeShouldUpdateGauge() {
        // Given
        long queueSize = 10L;
    ...
    @Test
    void recordFileSizeSmallFileShouldCategorizeCorrectly() {
        // Given
        ...
        // Then
        Counter sizeCounter =
                meterRegistry.find("fits_file_size_bytes_total").tag("type", fileType).counter();
        assertNotNull(sizeCounter);
        assertEquals(sizeBytes, sizeCounter.count());

        Counter categoryCounter =
                meterRegistry
                        .find("fits_file_size_category_total")
                        .tag("category", "small")
                        .counter();
    ...
    @Test
    void recordFileSizeMediumFileShouldCategorizeCorrectly() {
        // Given
    ...
    @Test
    void recordFileSizeLargeFileShouldCategorizeCorrectly() {
        // Given
    ...
    @Test
    void recordInstrumentMetricsShouldIncrementWithCorrectTags() {
        // Given
        ...
        Counter instrumentCounter =
                meterRegistry
                        .find("fits_processing_by_instrument_total")
    ...
    @Test
    void recordEfficiencyShouldIncrementEfficiencyCounters() {
        // Given
        ...
        Counter memoryCounter =
                meterRegistry.find("fits_processing_memory_efficiency_total").counter();
        assertNotNull(memoryCounter);
        assertEquals(0.92, memoryCounter.count());
    }

    @Test
    void multipleOperationsShouldAccumulateCorrectly() {
        // Given
